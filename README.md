...
위와 같은 손댈 수 없는 문제로 인한 손실에 대해 다소 무력함을 느껴 고뇌에 빠져 있는 중에,
전에 사이트를 만들 때 제 힘으로 문제를 찾고 해결했던 좋은 기억이 떠올라 개발자에 대해 찾아보았습니다.
...
끝마무리를 짓고 나서도 다음에 생길 수 있는 실수까지 고려해 꼼꼼하게 정리하는 습관을 가지게 되었습니다.
개발자 로서의 저는 확실치 않은 지식에 대해 안주하지 않고 계속해서 의문을 가지고 공부할 것이며,
블로그에 하루하루 깨달은 것과 문제해결 방법에 대해 빈틈없이 기록하며 성장하고 있습니다.
다른 이들보다 속도는 조금 느릴 수 있지만, 한편으론 배운 것에 대해 흐릿함 없이 좀 더 뚜렷하게 유지하고,
오류를 줄여 더 나은 성과를 볼 수 있다고 생각합니다.
협업의 사전적 의미는 ‘많은 노동자들이 협력하여 계획적으로 노동하는 일’이라고 기재 되어있습니다.
최상의 결과를 도출하는 협업은, 이 문장에 ‘즐겁게’ 라는 단어를 넣기만 하면 된다고 생각합니다.
최종 프로젝트인 팀 포트폴리오 작업을 하며 저는 이와 같은 즐거운 협업을 경험했고,
이 값진 경험을 원동력으로 거침없이 나아가 액티브한 개발자라는 꿈에 도달하기 위해 도전할 것입니다!
 </div>
